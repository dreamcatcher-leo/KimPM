...
DECLARE
  ...
  -- Feature IDs (P0)
  fid_p0_1 UUID := 'f0010001-0000-0000-0000-000000000001';
  fid_p0_2 UUID := 'f0010001-0000-0000-0000-000000000002';
  fid_p0_3 UUID := 'f0010001-0000-0000-0000-000000000003';
  fid_p0_4 UUID := 'f0010001-0000-0000-0000-000000000004';
  fid_p0_5 UUID := 'f0010001-0000-0000-0000-000000000005';
  fid_p0_6 UUID := 'f0010001-0000-0000-0000-000000000006';
  fid_p0_7 UUID := 'f0010001-0000-0000-0000-000000000007';
  -- Feature IDs (P1)
  fid_p1_1 UUID := 'f0010001-0000-0000-0000-000000000011';
  fid_p1_2 UUID := 'f0010001-0000-0000-0000-000000000012';
  fid_p1_3 UUID := 'f0010001-0000-0000-0000-000000000013';
  fid_p1_4 UUID := 'f0010001-0000-0000-0000-000000000014';
  fid_p1_5 UUID := 'f0010001-0000-0000-0000-000000000015';
  fid_p1_6 UUID := 'f0010001-0000-0000-0000-000000000016';
  fid_p1_7 UUID := 'f0010001-0000-0000-0000-000000000017';

  -- Spec IDs
  sid_p0_1_v1 UUID := 's0020001-0000-0000-0000-000000000001';
  sid_p0_1_v2 UUID := 's0020001-0000-0000-0000-000000000002';
  sid_p0_2_v1 UUID := 's0020001-0000-0000-0000-000000000003';
  sid_p0_3_v1 UUID := 's0020001-0000-0000-0000-000000000004';
  sid_p0_4_v1 UUID := 's0020001-0000-0000-0000-000000000005';
  sid_p0_5_v1 UUID := 's0020001-0000-0000-0000-000000000006';
  sid_p1_1_v1 UUID := 's0020001-0000-0000-0000-000000000011';
  sid_p1_5_v1 UUID := 's0020001-0000-0000-0000-000000000015';

  -- WeeklyPlan IDs
  wp_prev UUID := 'w0030001-0000-0000-0000-000000000001';
  wp_curr UUID := 'w0030001-0000-0000-0000-000000000002';
  wp_next UUID := 'w0030001-0000-0000-0000-000000000003';

  -- Report IDs (14개)
  rid_01 UUID := 'r0040001-0000-0000-0000-000000000001';
  rid_02 UUID := 'r0040001-0000-0000-0000-000000000002';
  rid_03 UUID := 'r0040001-0000-0000-0000-000000000003';
  rid_04 UUID := 'r0040001-0000-0000-0000-000000000004';
  rid_05 UUID := 'r0040001-0000-0000-0000-000000000005';
  rid_06 UUID := 'r0040001-0000-0000-0000-000000000006';
  rid_07 UUID := 'r0040001-0000-0000-0000-000000000007';
  rid_08 UUID := 'r0040001-0000-0000-0000-000000000008';
  rid_09 UUID := 'r0040001-0000-0000-0000-000000000009';
  rid_10 UUID := 'r0040001-0000-0000-0000-000000000010';
  rid_11 UUID := 'r0040001-0000-0000-0000-000000000011';
  rid_12 UUID := 'r0040001-0000-0000-0000-000000000012';
  rid_13 UUID := 'r0040001-0000-0000-0000-000000000013';
  rid_14 UUID := 'r0040001-0000-0000-0000-000000000014';

  -- Risk IDs
  risk_01 UUID := 'k0050001-0000-0000-0000-000000000001';
  risk_02 UUID := 'k0050001-0000-0000-0000-000000000002';
  risk_03 UUID := 'k0050001-0000-0000-0000-000000000003';
  risk_04 UUID := 'k0050001-0000-0000-0000-000000000004';
  risk_05 UUID := 'k0050001-0000-0000-0000-000000000005';
  risk_06 UUID := 'k0050001-0000-0000-0000-000000000006';
  risk_07 UUID := 'k0050001-0000-0000-0000-000000000007';
  risk_08 UUID := 'k0050001-0000-0000-0000-000000000008';

  -- Decision IDs
  dec_01 UUID := 'd0060001-0000-0000-0000-000000000001';
  dec_02 UUID := 'd0060001-0000-0000-0000-000000000002';
  dec_03 UUID := 'd0060001-0000-0000-0000-000000000003';
  dec_04 UUID := 'd0060001-0000-0000-0000-000000000004';

  -- ChangeRequest IDs
  cr_01 UUID := 'c0070001-0000-0000-0000-000000000001';
  cr_02 UUID := 'c0070001-0000-0000-0000-000000000002';
  cr_03 UUID := 'c0070001-0000-0000-0000-000000000003';

  -- CompletionCandidate IDs
  cc_01 UUID := 'x0080001-0000-0000-0000-000000000001';
  cc_02 UUID := 'x0080001-0000-0000-0000-000000000002';

  -- Question IDs
  q_01 UUID := 'q0090001-0000-0000-0000-000000000001';
  q_02 UUID := 'q0090001-0000-0000-0000-000000000002';
  q_03 UUID := 'q0090001-0000-0000-0000-000000000003';
  q_04 UUID := 'q0090001-0000-0000-0000-000000000004';

  -- MustCheck IDs
  mc_01 UUID := 'm0100001-0000-0000-0000-000000000001';
  mc_02 UUID := 'm0100001-0000-0000-0000-000000000002';
  mc_03 UUID := 'm0100001-0000-0000-0000-000000000003';
  mc_04 UUID := 'm0100001-0000-0000-0000-000000000004';
  mc_05 UUID := 'm0100001-0000-0000-0000-000000000005';
